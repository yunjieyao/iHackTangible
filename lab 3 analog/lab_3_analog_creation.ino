...
void loop() {
  ...
  analogWrite(ledRed, potValueLedAll/4);  // PWM the LED with the pot value (divided by 4 to fit in a byte)
  analogWrite(ledGreen, potValueLedAll/4);  // PWM the LED with the pot value (divided by 4 to fit in a byte)
  analogWrite(ledBlue, potValueLedAll/4);  // PWM the LED with the pot value (divided by 4 to fit in a byte)
  delay(1000);                     // wait 10 milliseconds before the next loop
